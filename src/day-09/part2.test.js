...
const {main, getTestInput, getInput, isTouching, getTailMoveFn, MoveFnMap} = require('./part2')
...
describe('day 09', () => {
  describe('part2', () => {
    ...
    test('should get correct moving function', () => {
      ...
      expect(getTailMoveFn([-2,0], [0,0])).toEqual(MoveFnMap.L)
      expect(getTailMoveFn([0,-2], [0,0])).toEqual(MoveFnMap.D)
    })
